		...
		<form id="join" class="form-horizontal" action="/shop01/changePasswd/"
			...
			<fieldset>
				...
				<div class="control-group">
					...
					<label class="control-label" for="password">비밀번호 :
						${check.memPassword}</label><br /> <label class="control-label" for="name">이름
						: ${check.memName}</label><br /> <label class="control-label" for="e-mail">이메일
						: ${check.email}</label><br /> <label class="control-label" for="address">주소
						: ${check.address}</label><br /> <label class="control-label" for="hp">전화번호
						: ${check.hp}</label><br /> <br /> <label class="control-label"
